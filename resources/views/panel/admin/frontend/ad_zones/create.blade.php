        ...
        <div class="container-xl">
            <div class="row">
                <div class="col-md-8 mx-auto">
                    <form id="page_form" action="{{route('dashboard.admin.frontend.adZone.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-[20px]">
                        ...
                        <div class="mb-[20px]">
                            ...
                            <input type="text" class="form-control" id="ad-client" name="ad_client" value="{{ old('ad_client') }}">
                        </div>
                        ...
                        <div class="mb-[20px]">
                            ...
                            <input type="text" class="form-control" id="ad-slot" name="ad_slot" value="{{ old('ad_slot') }}">
                        </div>
